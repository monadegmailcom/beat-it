...
# Install SSH server for RunPod remote terminal access and tmux for terminal multiplexing
RUN apt-get update && apt-get install -y openssh-server tmux && rm -rf /var/lib/apt/lists/*
