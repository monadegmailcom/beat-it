...
class SelfPlayWorker(threading.Thread):
    ...
    def get_and_reset_generated_count(self):
        """Atomically reads and resets the generated positions counter."""
        with self.counter_lock:
            count = self.generated_positions_count
            self.generated_positions_count = 0
        return count
...
if __name__ == '__main__':
    ...
    try:
        ...
        while step < total_training_steps:
            ...
            num_new_positions = worker.get_and_reset_generated_count()
            ...
            print(f"[Trainer] Worker generated {num_new_positions} positions. Running {steps_to_run} training steps to maintain ratio.")
            ...
            for _ in range(steps_to_run):
                ...
                if (step + 1) % log_freq_steps == 0:
                    ...
                    writer.add_scalar('Performance/Target_Replay_Ratio', target_replay_ratio, step)
